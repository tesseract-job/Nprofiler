...
public abstract class AbstractHeapGraphWriter implements HeapGraphWriter {
    ...
    protected void write() throws IOException {
        ...
        try {
            heap.iterate(new DefaultHeapVisitor() {
                ...
                public boolean doObj(Oop oop) {
                    try {
                        ...
                        throw new NprofilerException(exp.getMessage());
                    }
                    return false;
                }
            ...
            throw new NprofilerException(re.getMessage());
        }
    }
        ...
        if (blk != null) {
            try {
                blk.oopsDo(new AddressVisitor() {
                    ...
                    public void visitAddress(IiopUrl.Address handleAddr) {
                        try {
                            if (handleAddr != null) {
                    ...
                    public void visitCompOopAddress(IiopUrl.Address handleAddr) {
                        throw new NprofilerException("Should not reach here. JNIHandles are not compressed");
                    }
                });
            } catch (RuntimeException re) {
                throw new NprofilerException(re.getMessage());
    ...
    protected void writeGlobalJNIHandle(IiopUrl.Address handleAddr) throws IOException {
    }
